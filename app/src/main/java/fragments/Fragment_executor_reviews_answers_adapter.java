...
public class Fragment_executor_reviews_answers_adapter extends RecyclerView.Adapter<Fragment_executor_reviews_answers_adapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final Persons p = provider.getPerson(whoanswers);
